...
```SDARTS-RS: cd sota/cnn && python train_search.py --search_space=s1 --dataset=cifar10 --perturb_alpha=random```

```SDARTS-ADV: cd sota/cnn && python train_search.py --search_space=s1 --dataset=cifar10 --perturb_alpha=pgd_linf```
